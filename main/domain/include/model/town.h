...
// date: 2014-08-21
// summary: town.h
#ifndef _ASSIGNMENT_TRAINS_DOMAIN_MODEL_TOWN_H_
#define _ASSIGNMENT_TRAINS_DOMAIN_MODEL_TOWN_H_
#include <memory>
#include <string>
#include <map>
...
{
class CRoute;
class CTown : public ITown
{
  public:
    explicit CTown();
    explicit CTown(long id);
    explicit CTown(long id, const std::string name);
    CTown(const CTown& town);

  public:
    static const CTown& NullTown(void);
